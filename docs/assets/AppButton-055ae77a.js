import { bI as cva, as as defineComponent, aS as computed, bJ as twMerge, ax as openBlock, aP as createElementBlock, aH as createCommentVNode, aA as createVNode, az as withCtx, aB as createBaseVNode, aV as Fragment, aW as renderList, aD as normalizeClass, bc as normalizeProps, bd as guardReactiveProps, be as Transition, aC as renderSlot, ay as createBlock } from "./vendor-8f547009.js";
import { f as fadeTransition } from "./fade.transition-ff73e3ee.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { _ as __unplugin_components_0$1 } from "./AppIcon-937c595b.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { loaderVariant, get twMerge() {
      return twMerge;
    }, get buttonLoaderVariants() {
                ...
                (openBlock(), createElementBlock(
                  ...
                  renderList(4, (i) => {
                    return createBaseVNode(
                      ...
                      {
                        key: i,
                        class: normalizeClass(["orb", $setup.twMerge($setup.buttonLoaderVariants({ variant: $setup.loaderVariant }))])
                      },
                      null,
                      2
                      /* CLASS */
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    "button",
    {
      class: normalizeClass($setup.twMerge($setup.buttonVariants({ variant: $props.variant, size: $props.size }))),
