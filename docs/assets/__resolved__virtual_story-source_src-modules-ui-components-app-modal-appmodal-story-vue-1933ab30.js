const __resolved__virtual_storySource_srcModulesUiComponentsAppModalAppmodalStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcModulesUiComponentsAppModalAppmodalStoryVue as default
};
