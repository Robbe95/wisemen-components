import{d as s,B as r,o as i,c as a,t as l,m as p}from"./index-24ab217c.js";const c=[{component:"AppButton",name:"Button",files:[{name:"AppButton.vue",dir:"./src/modules/ui/components/app/buttons/app-button",placementDir:"app/buttons",type:"components",content:`<script setup lang="ts">
...
`}],internalDependencies:[],dependencies:["class-variance-authority"]},{component:"FormError",name:"FormError",files:[{name:"FormError.vue",dir:"./src/modules/ui/components/forms/error",placementDir:"forms/errors",type:"components",content:`<script setup lang="ts">
interface Props {
  errorMessage?: string
}
...
`},{name:"formInputFieldVariants.ts",dir:"./src/modules/ui/components/forms/field",placementDir:"forms/field",type:"components",content:`import type { VariantProps } from 'class-variance-authority'
import { cva } from 'class-variance-authority'
...
`}]},{component:"Icons",name:"Icons",files:[{name:"AddIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"ArrowDownIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"CheckmarkIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"ChevronDownIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"ChevronRightIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"CloseIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"EditIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"EyeClosedIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"EyeOpenIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"FilterIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"InfoIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"NoFilterIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"SearchIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"SettingsIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
  <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`},{name:"SortAscendingIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"SortDescendingIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"TrashIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
...
`},{name:"WarningIcon.vue",dir:"./src/icons",placementDir:"",type:"icons",content:`<template>
  <svg viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`}]},{component:"AppModal",name:"Modal",files:[{name:"AppModal.vue",dir:"./src/modules/ui/components/app/modal",placementDir:"app/modal",type:"components",content:`<script setup lang="ts">
import {
  Dialog,
  DialogPanel,
  DialogTitle,
...
`},{name:"appModalVariants.ts",dir:"./src/modules/ui/components/app/modal",placementDir:"app/modal",type:"components",content:`import type { VariantProps } from 'class-variance-authority'
import { cva } from 'class-variance-authority'
...
`}],dependencies:["@headlessui/vue"],internalDependencies:["AppText","AppButton","AppIcon"]},{component:"AppText",name:"Text",files:[{name:"AppText.vue",dir:"./src/modules/ui/components/app/text",placementDir:"app/text",type:"components",content:`<script setup lang="ts">
import { twMerge } from 'tailwind-merge'
...
`},{name:"appTextVariants.ts",dir:"./src/modules/ui/components/app/text",placementDir:"app/text",type:"components",content:`import type { VariantProps } from 'class-variance-authority'
import { cva } from 'class-variance-authority'
...
`}],internalDependencies:[]},{component:"AppTooltip",name:"Tooltip",files:[{name:"AppTooltip.vue",dir:"./src/modules/ui/components/app/tooltip",placementDir:"app/tooltip",type:"components",content:`<script setup lang="ts">
import {
  onMounted,
  ref,
} from 'vue'
...
`}],internalDependencies:[],dependencies:["@floating-ui/dom","@vueuse/core"]},{component:"TransitionExpand",name:"TransitionExpand",files:[{name:"TransitionExpand.vue",dir:"./src/modules/ui/components/transitions",placementDir:"transitions",type:"components",content:`<script lang="ts" setup>
interface Props {
  duration?: number
}
...
`}]}],C=s({__name:"ComponentView",setup(L){const t=r().params.componentName,o=c.find(n=>n.component===t);return(n,d)=>{var e;return i(),a("div",null,l((e=p(o))==null?void 0:e.files[0].content),1)}}});export{C as default};
