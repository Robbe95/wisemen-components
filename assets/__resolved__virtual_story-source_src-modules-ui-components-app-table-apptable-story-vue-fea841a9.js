const __resolved__virtual_storySource_srcModulesUiComponentsAppTableApptableStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcModulesUiComponentsAppTableApptableStoryVue as default
};
