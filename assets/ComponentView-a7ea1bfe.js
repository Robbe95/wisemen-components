import{d as s,B as r,o as i,c as a,t as l,m as p}from"./index-ede1bf55.js";const c=[{component:"AppButton",name:"Button",files:[{name:"AppButton.vue",dir:"./src/modules/ui/components/app/buttons/app-button",placementDir:"app/buttons",type:"components",content:`<script setup lang="ts">
...
`}]}],f=s({__name:"ComponentView",setup(u){const t=r().params.componentName,o=c.find(n=>n.component===t);return(n,d)=>{var e;return i(),a("div",null,l((e=p(o))==null?void 0:e.files[0].content),1)}}});export{f as default};
