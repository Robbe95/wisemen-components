import{d as s,B as r,o as a,c as i,t as l,m as p}from"./index-01ef52e5.js";const c=[{component:"AppButton",name:"Button",files:[{name:"AppButton.vue",dir:"./src/modules/ui/components/app/buttons/app-button",placementDir:"app/buttons",type:"components",content:`<script setup lang="ts">
...
`}]}],f=s({__name:"ComponentView",setup(u){const e=r().params.componentName,o=c.find(n=>n.component===e);return(n,d)=>{var t;return a(),i("div",null,l((t=p(o))==null?void 0:t.files[0].content),1)}}});export{f as default};
